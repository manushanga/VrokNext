...
public:
    ThreadPool_PyWrap(size_t size) : Vrok::ThreadPool(size) { }
...
int arr[] = { 1, 2, 3, 4 };
class DriverPyOutImpl : public Vrok::DriverJBufferOut::Events,
                        public wrapper<Vrok::DriverJBufferOut::Events> {
public:
    void OnThreadStart() { Vrok::Notify::GetInstance()->NotifyInformation("onTh start"); }
    void OnThreadEnd() { Vrok::Notify::GetInstance()->NotifyInformation("onTh end"); }
    void OnBuffer(double *buffer, int frames, StreamType type) override {
        ...
        GILLock lock;
        try {
            np::ndarray ndArray = np::from_data(
                    _buffer, np::dtype::get_builtin<double>(), p::make_tuple(_channels, _frames),
                    p::make_tuple(_frames * sizeof(double), sizeof(double)), p::object());
...
BOOST_PYTHON_MODULE(vrok) {
    ...
    class_<Vrok::Property<float>, bases<Vrok::PropertyBase>, boost::noncopyable>("PropertyFloat",
                                                                                 boost::python::no_init)
            .def("Get", get_float_func);
    class_<Vrok::Property<double>, bases<Vrok::PropertyBase>, boost::noncopyable>("PropertyDouble",
                                                                                  boost::python::init<>());
    class_<Vrok::Property<int>, bases<Vrok::PropertyBase>, boost::noncopyable>("PropertyInteger",
                                                                               boost::python::init<>());
    ...
    class_<Vrok::ComponentManager, boost::noncopyable>("ComponentManager", boost::python::no_init)
            .def("GetSingleton", &Vrok::ComponentManager::GetSingleton,
                 return_value_policy<reference_existing_object>())
            .def("GetComponent", &Vrok::ComponentManager::GetComponent,
                 return_value_policy<reference_existing_object>())
    ...
    class_<Vrok::DecoderFFMPEG, bases<Vrok::Decoder>, boost::noncopyable>("DecoderFFMPEG",
                                                                          boost::python::init<>())
    ...
    class_<Vrok::Player, bases<BufferGraph::Point, Vrok::Component, Runnable>, boost::noncopyable>(
            "Player", boost::python::init<>())
            ...
            .def("SetQueueNext", &Vrok::Player::SetQueueNext)
    ...
    class_<Vrok::EffectFIR, bases<BufferGraph::Point, Vrok::Component, Runnable>, boost::noncopyable>(
            "EffectFIR", boost::python::init<>())
    ...
    class_<Vrok::EffectSSEQ, bases<BufferGraph::Point, Vrok::Component, Runnable>, boost::noncopyable>(
            "EffectSSEQ", boost::python::init<>())
            .def("Flush", &Vrok::EffectSSEQ::Flush)
    ...
    class_<Vrok::DriverAlsa, bases<BufferGraph::Point, Vrok::Component, Runnable>, boost::noncopyable>(
            "DriverAlsa", boost::python::init<>())
    ...
    class_<Vrok::DriverPulse, bases<BufferGraph::Point, Vrok::Component, Runnable>, boost::noncopyable>(
            "DriverPulse", boost::python::init<>())
    ...
    class_<Vrok::DriverJBufferOut, bases<BufferGraph::Point, Vrok::Component, Runnable>, boost::noncopyable>(
            "DriverJBufferOut", boost::python::init<>())
